...
public class MainActivity19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS mark(name varchar,marks varchar);");
        db.execSQL("INSERT INTO mark VALUES('" + name + "','" + "" + "');");
...
//        int s= 0;
        String ss1 = "mobile application development";
        String ss2 = "True";
        String ss3 = "print";
        ...
        Cursor c1 = db.rawQuery("SELECT * FROM data WHERE name='"+name+"'",null);
        if(c1.moveToFirst())
        {
            db .execSQL("UPDATE mark SET marks='" + s +"' WHERE name='"+name+"';");
        }
        else
        {
            db.execSQL("INSERT INTO mark VALUES('" + name + "','" + "" + "');");
